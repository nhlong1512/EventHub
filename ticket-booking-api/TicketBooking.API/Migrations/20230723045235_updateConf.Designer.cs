...
namespace TicketBooking.API.Migrations
{
    ...
    [Migration("20230723045235_updateConf")]
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        ...
                        .HasDefaultValue("bf48aee6-1ba6-4806-b76d-8c2dc4ec8648");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 11, 52, 35, 212, DateTimeKind.Local).AddTicks(3470));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Event", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("bf48edee-5ec8-4774-beaf-dde0f95a82d5");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 11, 52, 35, 210, DateTimeKind.Local).AddTicks(6510));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("71ed14ba-bc9c-4bef-b08a-a9f496d5c123");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 11, 52, 35, 211, DateTimeKind.Local).AddTicks(6290));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Seat", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("2fd11e58-1c19-431d-934a-07693a4b7042");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 11, 52, 35, 212, DateTimeKind.Local).AddTicks(990));
