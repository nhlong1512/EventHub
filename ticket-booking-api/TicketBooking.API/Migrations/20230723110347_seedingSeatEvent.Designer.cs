...
namespace TicketBooking.API.Migrations
{
    ...
    [Migration("20230723110347_seedingSeatEvent")]
    partial class seedingSeatEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        ...
                        .HasDefaultValue("558296bc-c888-4c85-be03-9eb6aadc55fb");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 18, 3, 47, 611, DateTimeKind.Local).AddTicks(8530));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Event", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("12762196-b87a-4307-bec2-ce93f8e9878e");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 18, 3, 47, 609, DateTimeKind.Local).AddTicks(8720));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("f79276b1-a3f5-4274-95d5-74f2bed4637b");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 18, 3, 47, 610, DateTimeKind.Local).AddTicks(7960));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Seat", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("8a38fd6a-2d4e-40ec-95df-a7e3df4d78d2");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 18, 3, 47, 611, DateTimeKind.Local).AddTicks(5770));
