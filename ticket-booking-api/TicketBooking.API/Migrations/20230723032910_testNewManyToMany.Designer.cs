...
namespace TicketBooking.API.Migrations
{
    ...
    [Migration("20230723032910_testNewManyToMany")]
    partial class testNewManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        ...
                        .HasDefaultValue("9502cbac-0426-468b-964d-8c9279f59670");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 10, 29, 10, 629, DateTimeKind.Local).AddTicks(6250));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Event", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("55571418-4f6e-4b0c-90fc-31464cc73d51");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 10, 29, 10, 628, DateTimeKind.Local).AddTicks(4510));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("b12a49aa-bd3e-48ab-88fb-efca03a412e4");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 10, 29, 10, 629, DateTimeKind.Local).AddTicks(3960));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Seat", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("17135a56-4c46-4381-b905-715316152b75");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 10, 29, 10, 629, DateTimeKind.Local).AddTicks(5280));
