...
namespace TicketBooking.API.Migrations
{
    ...
    [Migration("20230723092424_addDuration")]
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        ...
                        .HasDefaultValue("12bd1d61-842e-437e-9a2c-8426edfa9cde");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 16, 24, 24, 335, DateTimeKind.Local).AddTicks(6200));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Event", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("ed8ccd25-a581-4a6a-97ca-47c35b01277c");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 16, 24, 24, 332, DateTimeKind.Local).AddTicks(8900));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("93e68f37-b196-4d63-9e63-b323aaa3e0e5");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 16, 24, 24, 334, DateTimeKind.Local).AddTicks(4590));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Seat", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("0f2cfd03-b1f5-46a1-886d-a1c8148da00d");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 16, 24, 24, 335, DateTimeKind.Local).AddTicks(2120));
