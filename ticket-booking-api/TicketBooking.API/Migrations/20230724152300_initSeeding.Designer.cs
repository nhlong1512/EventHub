...
namespace TicketBooking.API.Migrations
{
    ...
    [Migration("20230724152300_initSeeding")]
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        ...
                        .HasDefaultValue("53f17ae8-a044-4830-be04-1f15188d2ec8");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 24, 22, 22, 59, 984, DateTimeKind.Local).AddTicks(9220));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Event", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("f248188f-a7f6-4dba-bfe2-ff27c8e87b34");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 24, 22, 22, 59, 983, DateTimeKind.Local).AddTicks(5590));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("893b0991-d20a-4ed8-9984-cfa9116fb223");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 24, 22, 22, 59, 984, DateTimeKind.Local).AddTicks(2280));
            ...
            modelBuilder.Entity("TicketBooking.API.Models.Seat", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("41753aee-ab2c-4677-b626-94963ddd1f37");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 24, 22, 22, 59, 984, DateTimeKind.Local).AddTicks(7480));
