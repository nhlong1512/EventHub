  ...
  public class ApplicationDbContextSeeding
  {
    public static void Seed(ref ModelBuilder modelBuilder)
    {
      modelBuilder.Entity<EventType>().HasData(
        new EventType {Id = new Guid("eventType1"), Name = "Theater & Play"},
        new EventType {Id = new Guid("eventType2"), Name = "Concert"},
        new EventType {Id = new Guid("eventType3"), Name = "Sport"},
        new EventType {Id = new Guid("eventType4"), Name = "Comedy"}
      ); 
